...
#define SPI_CLOCK_DIV16 0x01    //divides AVR 16MHz clock rate by 16 to match 1 MHz clock of ADS1299 SPI // COME BACK TO THIS... 
...
//Register Addresses (Datasheet, pg. 44) -Rishan 
#define ID 0x00
#define CONFIG1 0x01
#define CONFIG2 0x02
#define CONFIG3 0x03
